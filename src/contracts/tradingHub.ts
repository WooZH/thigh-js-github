...
const abi: ReadonlyArray<JsonFragment> = [
    ...
    },
    {
        ...
        outputs: [
            {
                internalType: 'contract IDexCenter',
                name: '',
                type: 'address',
            },
        ],
