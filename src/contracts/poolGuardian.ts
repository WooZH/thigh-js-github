...
const abi: ReadonlyArray<JsonFragment> = [
    ...
    { anonymous: false, inputs: [], name: 'PoolGuardianInitiated', type: 'event' },
    {
        anonymous: false,
        inputs: [{ indexed: true, internalType: 'uint256', name: 'poolId', type: 'uint256' }],
        name: 'PoolListed',
    ...
    },
    {
        ...
        outputs: [{ internalType: 'uint256[]', name: '_poolIds', type: 'uint256[]' }],
        stateMutability: 'view',
        type: 'function',
    },
    {
    ...
    },
    {
        ...
        outputs: [
            ...
            { internalType: 'enum IPoolGuardian.PoolStatus', name: 'stateFlag', type: 'uint8' },
        ],
        stateMutability: 'view',
        type: 'function',
    },
    ...
    },
    {
        ...
        name: 'getStrPoolImplementations',
        outputs: [{ internalType: 'address', name: '', type: 'address' }],
        stateMutability: 'view',
        type: 'function',
    },
    ...
    },
    {
        inputs: [
            { internalType: 'address', name: 'stakedToken', type: 'address' },
            { internalType: 'enum IPoolGuardian.PoolStatus', name: 'status', type: 'uint8' },
        ],
        name: 'queryPools',
        outputs: [{ internalType: 'uint256[]', name: '', type: 'uint256[]' }],
        stateMutability: 'view',
    ...
    },
    {
        inputs: [
            ...
            { internalType: 'uint256', name: 'newMaxLeverage', type: 'uint256' },
        ],
        name: 'setMaxLeverage',
        outputs: [],
        stateMutability: 'nonpayable',
    ...
    },
    {
        ...
        name: 'setStrPoolImplementations',
        outputs: [],
        stateMutability: 'nonpayable',
        type: 'function',
    },
    {
        inputs: [{ internalType: 'address', name: 'newWrapRouter', type: 'address' }],
        name: 'setWrapRouter',
        outputs: [],
        stateMutability: 'nonpayable',
        type: 'function',
...
const contractName = 'PoolGuardian';

async function getContract() {
    return getThighInstance().ethUtil.getContractByName(contractName, abi);
}
